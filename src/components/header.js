                                ...
                                query !== '' ? (
                                    <List >
                                        {results.map(result => (
                                                    ...
                                                    <Link _hover={ { textDecoration:'underline' }} href={`/video/${result.slugs}`} textTransform='uppercase'>
                                                        <Flex flexDir='row ' alignItems='center'>
                                                            ...
                                                            <Flex marginLeft='10px' w='65%' flexDir='column' alignContent='center'>
                                                                ...
                                                                <Heading as='h2' lineHeight='1.2rem' fontFamily='Oswald' fontSize='.9rem' fontWeight='lighter' color='#595959'> {result.videoType} | Release Date: {result.releaseYear}</Heading>
                                                            </Flex>
                                                        </Flex>
                                                    </Link>
                                                </ListItem>
